...
document.addEventListener('DOMContentLoaded', () =>{
    ...
    initCommonUI();
    checkUserSession();
    new AuthManager('log_form', 'reg_form');
...
function renderDetails(item){
        ...
        <div class="offer_layout">
            ...
            <div class="right_column">
                <div class="booking_form">
                    ...
                    <button class="btn_book_now" onclick="startBooking(${item.offer_id})">Book now</button>
                </div>
            </div>
        </div>
    `;
    ...
    new CustomCalendar('booking_check_in', 'booking_check_out', item.bookings || []);
}
